...
- [x] Publicar a linha de base atual no GitHub e confirmar o CI remoto.
...
Definir empresa piloto, responsáveis, data e teto financeiro antes de iniciar a homologação
externa. A suíte comercial completa da IA permanece reservada para a proximidade do piloto,
evitando consumo antes do congelamento do código.
